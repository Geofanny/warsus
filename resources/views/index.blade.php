        ...
        <div class="container">
            <div class="row gy-4 justify-content-center justify-content-lg-between">
                <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Camilan Hemat,<br>Hanya di YuksMil!</h1>
                    <p data-aos="fade-up" data-aos-delay="100">Temukan jajanan berkualitas dengan harga bersahabat.</p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="#book-a-table" class="btn-get-started" style="background: #F0A04B;">Lihat Menu</a>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
            @foreach ($categories as $category)
                <div class="tab-pane fade @if ($loop->first) active show @endif" 
                     id="menu-{{ Str::slug($category->name) }}">
                        ...
                        @forelse($category->products as $product)
                            <div class="col-lg-4 col-md-6 col-sm-12 menu-item">
                                @if ($product->product_image)
                                    <a href="{{ asset('storage/'.$product->product_image) }}" class="glightbox">
                                        <img src="{{ asset('storage/'.$product->product_image) }}" class="menu-img img-fluid" alt="{{ $product->name }}" style="object-fit: cover; width: 100%; height: 200px; border-radius: 8px;">
                                    </a>
                                @else
                    ...
                    <div class="tab-pane fade @if ($loop->first) active show @endif"
                        ...
                        <div class="row gy-5">
                            @forelse($category->products as $product)
                                <div class="col-lg-4 col-md-6 col-sm-12 menu-item">
                                    @if ($product->product_image)
                                        <a href="{{ route('index.show', $product->name) }}">
                                            <img src="{{ asset('storage/' . $product->product_image) }}"
                                                class="menu-img img-fluid" alt="{{ $product->name }}"
                                                style="object-fit: cover; width: 100%; height: 200px; border-radius: 8px;">
                                        </a>
                                    @else
                                        <img src="{{ asset('storage/default.jpg') }}" class="menu-img img-fluid"
                                            alt="No Image"
                                            style="object-fit: cover; width: 100%; height: 200px; border-radius: 8px;">
                                    @endif
                                    <h4>{{ $product->name }}</h4>
